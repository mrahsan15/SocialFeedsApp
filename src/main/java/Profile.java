        ...
        try {
            ...
            try{
                if((user.equals("null"))){
                    ...
                    ResponseList<Status> statuses= twitter.getUserTimeline(Long.parseLong(user), paging);
                    ...
                    mediacount = ((TimelineFeedObject)timelinefeeds.get(0)).medianumber;
                    follower =((TimelineFeedObject)timelinefeeds.get(0)).followers;
                    following =((TimelineFeedObject)timelinefeeds.get(0)).followings;
                    favorites = ((TimelineFeedObject)timelinefeeds.get(0)).favorites;
                }
...
"								<div class=\"current-profile\" style=\"background:"+((TimelineFeedObject)timelinefeeds.get(0)).UserProfilePic+";\">\n" +
"									<div class=\"user-bg\"></div>\n" +
"									<div class=\"user-pic\" style=\"background:url("+((TimelineFeedObject)timelinefeeds.get(0)).UserProfilePic+") no-repeat;\">&nbsp; </div>\n" +
"									<div class=\"user-details\">\n" +
"										<h4 class=\"user-name\">"+((TimelineFeedObject)timelinefeeds.get(0)).UserFullName+"<i>!</i></h4>\n" +
"										<h5 class=\"description\">"+((TimelineFeedObject)timelinefeeds.get(0)).Bio+".</h5>\n" +
"									</div>\n" +
